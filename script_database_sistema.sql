...
select * from atividade_caixa;

select funcionario.nome_funcionario, cpf_funcionario, atividade_caixa.data_atividade, atividade_caixa.valor_retirado 
...
select * from relatorio_retirada;
